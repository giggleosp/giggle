...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    watch: {
      ...
      compass: {
        files: ['<%= yeoman.app %>/assets/{,*/}*.{scss,css}'],
    ...
    wiredep: {
      ...
      sass: {
        src: ['<%= yeoman.app %>/assets/{,*/}*.{scss,css}'],
    ...
    copy: {
      dist: {
        files: [{
          ...
          expand: true,
          cwd: '.',
          src: 'bower_components/bootstrap-css-official/assets/fonts/bootstrap/*',
          dest: '<%= yeoman.dist %>'
        }]
      },
      styles: {
